...
2. **Run `docker-compose up`:**
   ...
   To build and start the containers defined in the `docker-compose.yml` file, use the following command:
...
- If you've configured your docker-compose.yml file correctly, you can access the Flask application in a web browser at http://localhost:{host_port}, where {host_port} is the port on your host machine that you mapped to the Flask application container's port.
